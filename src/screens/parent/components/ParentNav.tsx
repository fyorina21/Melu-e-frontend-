...
const TABS = ['Dashboard', 'Progress', 'Observations', 'Reports', 'Messages', 'Notifications'];
...
export default function ParentNav({ activeTab, onTabPress }: ParentNavProps) {
    ...
    <View style={styles.wrap}>
      ...
      <View style={styles.userBlock}>
        <View>
          ...
          <Text style={typography.caption}>Parent</Text>
        </View>
