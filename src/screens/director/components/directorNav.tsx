...
const TABS = ['Dashboard', 'Scheduling', 'Approvals', 'Parents', 'Reports', 'Progress', 'Builder'];
...
export default function DirectorNav({ activeTab, onTabPress }: DirectorNavProps) {
    ...
    <View style={styles.wrap}>
      ...
      <View style={styles.userBlock}>
        <View>
          ...
          <Text style={typography.caption}>Director</Text>
        </View>
